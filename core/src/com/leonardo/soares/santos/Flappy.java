...
public class Flappy extends ApplicationAdapter {
    ...
    public void create () {
        ...
        passaros = new Texture[8];
        passaros[0] = new Texture("e1.png");
        passaros[1] = new Texture("e2.png");
        passaros[2] = new Texture("e3.png");
        passaros[3] = new Texture("e4.png");
        passaros[4] = new Texture("e5.png");
        passaros[5] = new Texture("e6.png");
        passaros[6] = new Texture("e7.png");
        passaros[7] = new Texture("e8.png");

        fundo = new Texture("fundo.jpg");
        canoBaixo = new Texture("cano_baixo.png");
        canoTopo = new Texture("cano_topo.png");
        gameOver = new Texture("game_over.png");
       // fundoEsp = new Texture("ground.png");
    ...
    public void render () {
        ...
        if( estadoJogo == 0 ){//Não iniciado
            ...
            if( estadoJogo == 1 ){//iniciado
                ...
                posicaoMovimentoCanoHorizontal -= deltaTime * 270;
                if (pontuacao>=5) {
                ...
                if (pontuacao>=10){
                    ...
                    posicaoMovimentoCanoHorizontal -= deltaTime * 340;
                }
                if (pontuacao>=15){

                    posicaoMovimentoCanoHorizontal -= deltaTime * 380;
                }
                if (pontuacao>=20){
                    ...
                    posicaoMovimentoCanoHorizontal -= deltaTime * 460;
                }if (pontuacao>=30){
       ...
       // batch.draw(fundoEsp, 0, 0, larguraDispositivo, alturaDispositivo/20);
